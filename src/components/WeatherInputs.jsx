...
function WeatherInputs() {
  return (
    <div className="flex flex-col md:flex-row justify-center my-8">
        <div className="flex flex-row md:w-3/4 justify-center space-x-4 items-center">
        ...
        <div className="flex flex-row md:w-1/4 justify-center md:my-0 my-4 md:justify-start items-center">
